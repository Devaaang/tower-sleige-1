...
function setup() {
  ...
  box22 = new GreenBox(800,135,20,30);
  box23 = new BlueBox(820,135,20,30);
  box24 = new YellowBox(840,135,20,30);
  box25 = new RedBox(860,135,20,30);
  box26 = new GreenBox(880,135,20,30);
  box27 = new YellowBox(900,135,20,30);

  box28 = new BlueBox(810,105,20,30);
  box29 = new RedBox(830,105,20,30);
  box30 = new YellowBox(850,105,20,30);
  box31 = new GreenBox(870,105,20,30);
  box32 = new RedBox(890,105,20,30);

  box33 = new YellowBox(820,75,20,30);
  box34 = new BlueBox(840,75,20,30);
  box35 = new RedBox(860,75,20,30);
  box36 = new GreenBox(880,75,20,30);
  
  box37 = new YellowBox(830,45,20,30);
  box38 = new BlueBox(850,45,20,30);
  box39 = new GreenBox(870,45,20,30);

  box40 = new RedBox(840,15,20,30);
  box41 = new YellowBox(860,15,20,30);

  box42 = new BlueBox(850,-5,20,30);

  ball = new Ball(0,0,50);

  spring = new Projectile(ball.body,{x:200,y:200});

  ground = new Platform(400,390,1200,20);

  groundHovering = new Platform(850,200,200,20);
